...
import com.example.a2lytics.databinding.FragmentVoiceInputBinding
...
class VoiceInputFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentVoiceInputBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.textButton.setOnClickListener {
            findNavController().navigate(R.id.action_voiceInputFragment_to_advanceFragment)
        }
